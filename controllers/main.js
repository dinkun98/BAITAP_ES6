...
import { clothesList } from "../controllers/clothesList.js"

let clList = new clothesList();

// Ham rut gon cu phap lay elementByID
const getEle = (id) => {
    return document.getElementById(id);
}

//Ham hien thi danh sach quan ao 
const showAo = () => {
    let divDanhSachAo = getEle("clothes");

    //Tao doi tuong ao va them ao vao danh sach
    //duyet mang data
